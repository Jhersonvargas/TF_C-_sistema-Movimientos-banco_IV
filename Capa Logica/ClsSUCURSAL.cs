...
//CREAMOS LA CLASE SURCUSAL QUE CONTENDRA LA FUNCIONES Y PROCEDIMIENTOS A
...
namespace TF_JhersonVargas.Capa_Logica
{
    ...
    internal class ClsSUCURSAL
    {
        ...
        //CREAMOS EL METOD LlenarcomboxSucursal USANDO EL PROCEDIMIENTO ALMACENADO Llenar_Sucursal
        //EL CUAL SERA PARA MOSTRAR LOS ELEMENTOS DE BANCO EN EL COMBOX DEL BANCO
        public static void LlenarcomboxSucursal()
        {
            ...
            da.SelectCommand.CommandText = "Llenar_Sucursal";
